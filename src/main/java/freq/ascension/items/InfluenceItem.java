...
public class InfluenceItem {
    ...
    public static boolean isInfluenceItem(ItemStack stack) {
        ...
        if (customData != null && customData.has(DataComponents.CUSTOM_DATA))
            return customData.get(DataComponents.CUSTOM_MODEL_DATA).getString(0) == CUSTOM_MODEL_DATA_STRING;
        return false;
    }

    public static ItemStack getInfluenceDisplayItem(Player Player) {
        ...
        item.set(DataComponents.LORE, new ItemLore(
                List.of(
                        Component.literal("Passive: ")
                                ...
                                .append(Component
                                        .literal(Utils.smallCaps(passive != null ? passive.getOrderName() : "None"))),
                        Component.literal("Utility: ")
                                .withStyle(ChatFormatting.LIGHT_PURPLE)
                                .append(Component
                                        .literal(Utils.smallCaps(utility != null ? utility.getOrderName() : "None"))),
                        Component.literal("Combat: ")
                                .withStyle(ChatFormatting.RED)
                                .append(Component.literal(
                                        Utils.smallCaps(combat != null ? combat.getOrderName() : "None"))))));
        return item;
    }
}
